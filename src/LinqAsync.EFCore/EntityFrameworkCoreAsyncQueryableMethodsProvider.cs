...
namespace LinqAsync.EFCore
{
    ...
    public class EntityFrameworkCoreAsyncQueryableMethodsProvider : IAsyncQueryableMethodsProvider
    {
        ...
        /// </summary>
        public async Task<TSource?> FirstOrDefaultAsync<TSource>(
            IQueryable<TSource> source,
            CancellationToken   cancel = default)
        {
            return await EntityFrameworkQueryableExtensions.FirstOrDefaultAsync(source, cancel);
        }
        ...
        public async Task<TSource?> FirstOrDefaultAsync<TSource>(
            ...
            CancellationToken               cancel = default)
        {
            return await EntityFrameworkQueryableExtensions.FirstOrDefaultAsync(source, predicate, cancel);
        }
        ...
        /// </summary>
        public async Task<TSource?> LastOrDefaultAsync<TSource>(
            IQueryable<TSource> source,
            CancellationToken   cancel = default)
        {
            return await EntityFrameworkQueryableExtensions.LastOrDefaultAsync(source, cancel);
        }
        ...
        public async Task<TSource?> LastOrDefaultAsync<TSource>(
            ...
            CancellationToken               cancel = default)
        {
            return await EntityFrameworkQueryableExtensions.LastOrDefaultAsync(source, predicate, cancel);
        }
        ...
        /// </summary>
        public async Task<TSource?> SingleOrDefaultAsync<TSource>(
            IQueryable<TSource> source,
            CancellationToken   cancel = default)
        {
            return await EntityFrameworkQueryableExtensions.SingleOrDefaultAsync(source, cancel);
        }
        ...
        public async Task<TSource?> SingleOrDefaultAsync<TSource>(
            ...
            CancellationToken               cancel = default)
        {
            return await EntityFrameworkQueryableExtensions.SingleOrDefaultAsync(source, predicate, cancel);
        }
